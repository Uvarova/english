...
public class ServiceController {
    ...
    @PostMapping("forum")
    public String sendMess(@RequestParam(name = "text", required = false, defaultValue = "") String text, @RequestParam(name = "tag", required = false, defaultValue = "") String tag, Map<String, Object> model) {
